    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        primary: '#2563eb', // blue-600 (Sesuai app.blade.php)
                        secondary: '#1e40af', // blue-800 (Sesuai app.blade.php)
                    },
                    fontFamily: {
...
<body class="bg-gray-50 text-gray-800 font-sans antialiased">
    ...
    <nav class="fixed w-full z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div>
                    @auth
                        <a href="{{ url('/dashboard') }}" class="px-6 py-2.5 bg-primary hover:bg-secondary text-white font-medium rounded-full text-sm transition-all shadow-lg shadow-blue-500/30">
                            Dashboard Saya
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="group relative px-6 py-2.5 bg-white text-primary border-2 border-primary/20 hover:border-primary font-bold rounded-xl text-sm transition-all">
    ...
    <section class="relative pt-32 pb-20 lg:pt-60 lg:pb-60 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 text-primary text-sm font-bold mb-6 animate-fade-in-up">
                <span class="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
                Sistem Peminjaman Terintegrasi SMKN 1 Denpasar
            </div>

            <h1 class="text-6xl lg:text-8xl font-bold tracking-tight mb-6 leading-tight text-gray-900">
                Satu Sekolah,<br>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <a href="#alur" class="w-full sm:w-auto px-8 py-4 bg-white border border-gray-200 text-gray-700 font-bold rounded-2xl text-lg hover:bg-gray-50 transition-all">
                    Lihat Alur
                </a>
            </div>
        </div>

        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-tr from-blue-100 to-transparent rounded-full blur-3xl -z-10 opacity-60"></div>
    </section>

    <section class="py-10 bg-white border-y border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p class="text-center text-sm font-bold text-gray-400 uppercase tracking-widest mb-8">Didukung Oleh 12 Jurusan Kompetensi</p>
            
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                @if(isset($departments))
                    @foreach($departments as $dept)
                    <div class="group p-4 rounded-xl bg-gray-50 border border-transparent hover:border-primary/20 hover:bg-blue-50 transition-all cursor-default text-center">
                        <span class="block text-2xl font-bold text-gray-900 group-hover:text-primary mb-1">{{ $dept->value }}</span>
    ...
    <section id="alur" class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">Sistem Peminjaman Terpusat</h2>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-md transition-all">
                    <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                        <span class="text-6xl font-bold text-primary">01</span>
                    </div>
                    <div class="w-14 h-14 bg-blue-50 rounded-2xl flex items-center justify-center text-primary mb-6">
    ...
    <footer class="bg-white border-t border-gray-200 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p class="text-gray-400 text-sm">
                &copy; {{ date('Y') }} SMK Negeri 1 Denpasar. Development by RPL Team.
            </p>
        </div>
    </footer>
